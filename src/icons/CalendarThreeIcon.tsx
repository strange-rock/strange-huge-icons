...
export function CalendarThreeIcon({
  size = 24,
  color = "currentColor",
  animated: _animated,
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <path d="M16 2V6M8 2V6" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <path d="M11.9955 14H12.0045M11.9955 18H12.0045M15.991 14H16M8 14H8.00897M8 18H8.00897" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </motion.svg>
  );
}
