...
function FolderOneIcon({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    framerMotion.motion.svg,
    {
      ...
      style: { cursor: "pointer" },
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(framerMotion.motion.g, { animate: { opacity: showClosed ? 1 : 0 }, initial: { opacity: 1 }, transition: T, children: /* @__PURE__ */ jsxRuntime.jsx("g", { transform: "translate(-0.9,-1) scale(1.2,1.333)", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: CLOSED_BG, ...pathProps }) }) }),
        /* @__PURE__ */ jsxRuntime.jsxs(framerMotion.motion.g, { animate: { opacity: showHover ? 1 : 0 }, initial: { opacity: 0 }, transition: T, children: [
          /* @__PURE__ */ jsxRuntime.jsx("g", { transform: "translate(-1.13,-1.29) scale(1.501,1.714)", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: OPEN_BG, ...pathProps }) }),
          /* @__PURE__ */ jsxRuntime.jsx("g", { transform: "translate(-1,-1.5) scale(1.333,2.0)", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: HOVER_FG, ...pathProps }) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs(framerMotion.motion.g, { animate: { opacity: showOpen ? 1 : 0 }, initial: { opacity: 0 }, transition: T, children: [
          /* @__PURE__ */ jsxRuntime.jsx("g", { transform: "translate(-1.13,-1.29) scale(1.501,1.714)", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: OPEN_BG, ...pathProps }) }),
          /* @__PURE__ */ jsxRuntime.jsx("g", { transform: "translate(-0.9,-1.8) scale(1.2,2.4)", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: OPEN_FG, ...pathProps }) })
        ] })
      ]
    }
  );
