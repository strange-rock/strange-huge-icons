...
function MoreHorizontalIcon({
  ...
  return /* @__PURE__ */ jsxs(
    motion.svg,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("path", { d: "M12.0045 11.5C12.5568 11.5 13.0045 11.9477 13.0045 12.5C13.0045 13.0523 12.5568 13.5 12.0045 13.5C11.4522 13.5 11.0045 13.0523 11.0045 12.5C11.0045 11.9477 11.4522 11.5 12.0045 11.5Z" }),
        /* @__PURE__ */ jsx("path", { d: "M18.0045 11.5C18.5568 11.5 19.0045 11.9477 19.0045 12.5C19.0045 13.0523 18.5568 13.5 18.0045 13.5C17.4522 13.5 17.0045 13.0523 17.0045 12.5C17.0045 11.9477 17.4522 11.5 18.0045 11.5Z" }),
        /* @__PURE__ */ jsx("path", { d: "M6.00449 11.5C6.55677 11.5 7.00449 11.9477 7.00449 12.5C7.00449 13.0523 6.55677 13.5 6.00449 13.5C5.4522 13.5 5.00449 13.0523 5.00449 12.5C5.00449 11.9477 5.4522 11.5 6.00449 11.5Z" })
      ]
    }
  );
}
...
function FolderOneIcon({
  ...
  return /* @__PURE__ */ jsxs(
    motion.svg,
    {
      ...
      style: { cursor: "pointer" },
      children: [
        /* @__PURE__ */ jsx(motion.g, { animate: { opacity: showClosed ? 1 : 0 }, initial: { opacity: 1 }, transition: T, children: /* @__PURE__ */ jsx("g", { transform: "translate(-0.9,-1) scale(1.2,1.333)", children: /* @__PURE__ */ jsx("path", { d: CLOSED_BG, ...pathProps }) }) }),
        /* @__PURE__ */ jsxs(motion.g, { animate: { opacity: showHover ? 1 : 0 }, initial: { opacity: 0 }, transition: T, children: [
          /* @__PURE__ */ jsx("g", { transform: "translate(-1.13,-1.29) scale(1.501,1.714)", children: /* @__PURE__ */ jsx("path", { d: OPEN_BG, ...pathProps }) }),
          /* @__PURE__ */ jsx("g", { transform: "translate(-1,-1.5) scale(1.333,2.0)", children: /* @__PURE__ */ jsx("path", { d: HOVER_FG, ...pathProps }) })
        ] }),
        /* @__PURE__ */ jsxs(motion.g, { animate: { opacity: showOpen ? 1 : 0 }, initial: { opacity: 0 }, transition: T, children: [
          /* @__PURE__ */ jsx("g", { transform: "translate(-1.13,-1.29) scale(1.501,1.714)", children: /* @__PURE__ */ jsx("path", { d: OPEN_BG, ...pathProps }) }),
          /* @__PURE__ */ jsx("g", { transform: "translate(-0.9,-1.8) scale(1.2,2.4)", children: /* @__PURE__ */ jsx("path", { d: OPEN_FG, ...pathProps }) })
        ] })
      ]
    }
  );
